...
public record GcReferenceDomainConfig(
        int metadataScanPageSize, int maxAuthoritiesPerSnapshot, int maxReferencesPerSnapshot) {
    ...
    public GcReferenceDomainConfig {
        ...
        requireInRange(maxAuthoritiesPerSnapshot, 1, MAX_SNAPSHOT_VALUES, "maxAuthoritiesPerSnapshot");
        requireInRange(maxReferencesPerSnapshot, 1, MAX_SNAPSHOT_VALUES, "maxReferencesPerSnapshot");
    }
