...
public record ObjectPreparedPrimaryAppend(
        StreamId streamId,
        int recordCount,
        int entryCount,
        long logicalBytes,
        ...
        implements PreparedPrimaryAppend {
    public ObjectPreparedPrimaryAppend {
        Objects.requireNonNull(streamId);
        Objects.requireNonNull(preparedObject);
        Objects.requireNonNull(request);
        if (!request.streamId().equals(streamId)) {
