...
public record StorageExecutionPlan(
    ...
    public StorageExecutionPlan {
        profile = Objects.requireNonNull(profile).canonical();
        Objects.requireNonNull(primaryTargetType);
        Objects.requireNonNull(publicationMode);
        Objects.requireNonNull(allowedDurability);
        Objects.requireNonNull(ackBoundary);
    }
}
