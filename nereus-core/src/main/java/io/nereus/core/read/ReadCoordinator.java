...
import io.nereus.objectstore.wal.WalReadResult;
import io.nereus.objectstore.wal.WalSliceReadStats;
...
public final class ReadCoordinator implements AutoCloseable {
    ...
    private static void validateReadAccounting(
        ...
        Set<io.nereus.api.ObjectId> observedObjects = new HashSet<>();
    ...
    private record RangeIdentity(
            io.nereus.api.ObjectId objectId,
            long objectOffset,
            long objectLength,
