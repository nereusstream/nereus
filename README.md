...
Fetch-operation、binding-first leader manager、exact stable-head snapshot and storage-profile policy slices are in progress，
...
F9-M2 binding/checkpoint/recovery boundary and the M3 raw Kafka batch、stable partition append/read and profile-policy slices；its code-level
