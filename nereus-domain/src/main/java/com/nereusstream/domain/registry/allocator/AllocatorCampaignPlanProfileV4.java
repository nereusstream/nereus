...
/** Canonical source-independent physical inventory and budget identity for ADR-0125. */
public final class AllocatorCampaignPlanProfileV4 {
    public static final String SCHEMA = "NEREUS_V2_M3_ALLOCATOR_CAMPAIGN_PLAN_V4";
    ...
    private AllocatorCampaignPlanProfileV4() {}
    ...
    public static Sha256Digest zeroDecisionPlanDigest() {
        ...
        canonical
                ...
                .append(AllocatorEvidenceAdmissionPolicyV4.OFFER_HORIZON_SECONDS)
                .append('\n')
                .append("terminalAdmissionDrainSeconds=")
                .append(AllocatorEvidenceAdmissionPolicyV4.TERMINAL_ADMISSION_DRAIN_SECONDS)
                .append('\n')
                .append("cleanupGraceSeconds=")
                .append(AllocatorEvidenceAdmissionPolicyV4.CLEANUP_GRACE_SECONDS)
                .append('\n')
                .append("phaseBudgetSeconds=900,5400,7200,5400,13776,1640,600\n")
                .append("nativeExecutionProfileSha256=")
                .append(AllocatorNativeExecutionProfileV4.executionProfileDigest()
                        .toHex())
                .append('\n')
                .append("workloadScheduleSha256=")
                .append(AllocatorNativeExecutionProfileV4.scheduleDigest().toHex())
                .append('\n');
    ...
    public static List<String> zeroDecisionActionIdentities() {
        ...
        if (AllocatorCampaignV3.LOGICAL_PERFORMANCE_CELLS != LOGICAL_INTERVAL_CELLS
            ...
            throw new IllegalStateException("allocator V4 physical action inventory differs from ADR 0125");
        }
