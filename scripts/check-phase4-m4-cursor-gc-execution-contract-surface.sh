...
require_literal "new GcMetadataRetirementRegistry(List.of())" "$runtime"
require_literal "cursor physical-GC runtime accepts only empty cursor metadata-removal plans" "$runtime"
