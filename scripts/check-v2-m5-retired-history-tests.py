#!/usr/bin/env python3
"""Reject evidence scope and authority expansion in the retired history projection."""
import copy
import importlib.util
from pathlib import Path
import unittest
spec = importlib.util.spec_from_file_location("checker", Path(__file__).with_name("check-v2-m5-retired-history.py"))
...
class ProjectionTest(unittest.TestCase):
    ...
    def test_rejects_native_authority_claim(self):
        ...
        value["nativeNamespaceQuotaAndRestartHeadroomIntegrated"] = True
