...
require_literal 'scanProtections(' "$ownerless"
require_literal '"preflight ownerless physical-root protections"' "$ownerless"
require_literal "OWNERLESS_ORPHAN_CANDIDATE" "$ownerless"
require_literal "snapshotForDeletion(candidate.referenceQuery())" "$ownerless"
