...
require_literal "M4 through checkpoint AN" \
    "docs/automq-like-stream-storage/README.md"
...
echo "Phase 4 M1-M3 final status plus M4 through AN and M5 through AI, source lock, gates, and local links verified."
