#!/usr/bin/env python3
"""Create one immutable, byte-verified archive of a failed allocator formal attempt."""
...
def main() -> int:
    ...
    identity = {
        ...
        "campaignStatus": args.terminal_status,
        "terminalReason": result_value["terminalReason"],
        "terminalDetail": result_value.get("terminalDetail", ""),
        "terminalDetailSha256": hashlib.sha256(result_value.get("terminalDetail", "").encode()).hexdigest(),
        "checkpointSequence": result_value["checkpointSequence"],
