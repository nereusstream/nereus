...
m5_container="nereus-m5-gc-quota-oxia-$$"
m5_output="$m5_repo_root/build/m5-gc-quota-oxia/$m5_container"
mkdir -p "$m5_output"
m5_cleanup() {
...
docker run --detach \
  --name "$m5_container" \
  --label com.nereusstream.evidence=v2-m5-gc-quota-implementation \
...
paths.extend(root / name for name in ("build.gradle.kts", "nereus-storage-object/build.gradle.kts",
    "nereus-metadata-oxia/build.gradle.kts", "scripts/run-v2-m5-gc-quota-oxia-check.sh"))
...
"$m5_repo_root/gradlew" \
  ...
  "-Pv2M5QuotaOxiaRestartCheckpoint=$m5_output/restart-checkpoint.txt" \
  v2M5GcQuotaCheck \
  :nereus-metadata-oxia:v2M5GcQuotaOxiaRestartWriteTest \
  --console=plain
...
"$m5_repo_root/gradlew" \
  ...
  "-Pv2M5RetentionOxiaServiceAddress=127.0.0.1:$m5_service_port" \
  "-Pv2M5QuotaOxiaRestartCheckpoint=$m5_output/restart-checkpoint.txt" \
  :nereus-metadata-oxia:v2M5GcQuotaOxiaRestartReadTest \
  --console=plain
...
for module, task, name, count in (
    ("nereus-storage-object", "v2M5PermanentDoneTest", "com.nereusstream.storage.object.gc.M5PermanentDoneV2Test", 9),
    ...
    ("nereus-metadata-oxia", "v2M5PermanentDoneRealOxiaTest", "com.nereusstream.metadata.oxia.v2.retention.M5PermanentDoneOxiaIntegrationTest", 4),
    ("nereus-storage-object", "v2M5GcQuotaTest", "com.nereusstream.storage.object.gc.M5GcQuotaV2Test", 9),
    ("nereus-metadata-oxia", "v2M5GcQuotaRealOxiaTest", "com.nereusstream.metadata.oxia.v2.retention.M5GcQuotaOxiaIntegrationTest", 8),
    ("nereus-metadata-oxia", "v2M5GcQuotaOxiaRestartWriteTest", "com.nereusstream.metadata.oxia.v2.retention.M5GcQuotaOxiaRestartTest", 1),
    ("nereus-metadata-oxia", "v2M5GcQuotaOxiaRestartReadTest", "com.nereusstream.metadata.oxia.v2.retention.M5GcQuotaOxiaRestartTest", 1),
):
...
summary = {
    "schema": "NEREUS_V2_M5_GC_QUOTA_RUN_V2",
    ...
    "continuousQuotaSettledTerminals": 130, "quotaHeadEncodedBytes": 272, "permanentQuotaEntryEncodedBytes": 156,
    "canonicalNativeKeyValueBytesMeasured": True, "pendingOperationsMaximum": 1,
    "everyGrantAndRefundWriteDeliveryBoundaryRecovered": True,
    "heldNativeReservationAndRefundAbaRejected": True,
    "emptyRootInitializationRejectsLegacyAuthority": True,
    "existingIntentCompletesWithFullPendingQuotaAfterRestart": True,
    "operatorCapacityExpansionAfterRestartVerified": True,
    "backendWalReplicaDiskSpaceReserved": False,
    "allNamespaceWritersQuotaAdmissionComplete": False,
    "compactDoneAndExistingIntentSurvivedServerRestart": True,
    "actualProviderOrBookKeeperDeletionVerified": False,
    "nativeUniqueNamespaceAdmissionComplete": False, "configuredRouteDurableNamespaceQuotaIntegrated": True,
...
PY
printf 'PASS_V2_M5_GC_QUOTA_REAL_OXIA_NON_PROMOTABLE image=%s id=%s output=%s\n' \
