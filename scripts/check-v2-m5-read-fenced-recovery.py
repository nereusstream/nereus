...
EXPECTED = {'schema': 'NEREUS_V2_M5_READ_FENCED_RECOVERY_PROJECTION_V2',
 ...
 'focusedTests': {'coordinatorAndGuardTests': 26,
...
def validate(root):
    ...
    checks = {
        "M5TargetDeleteAuthorityStateMachineV1.java": [
            ...
            "recordRecoveryVeto", "current.recoveryVeto().isPresent()",
        ...
        "M5TargetDeleteAuthorityCodecV1.java": [
            "BASE_VERSION = 4", "VERSION = 5", "writeObservationContext", "readObservationContext", "identity.fencedAuthoritySha256()"],
