...
require_literal "GcGlobalReferenceScope.unsupported()" "$generation"
require_literal "GcGlobalReferenceScope.resolveStreams" "$generation"
...
require_literal "GcGlobalReferenceScope.unsupported()" "$append"
require_literal "GcGlobalReferenceScope.resolveStreams" "$append"
...
require_literal "GcGlobalReferenceScope.unsupported()" "$materialization"
require_literal "GcGlobalReferenceScope.resolveStreams" "$materialization"
