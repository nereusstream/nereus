...
def validate_runtime_contract(root: Path) -> None:
    ...
    require_literals(
        ...
        (
            ...
            "nMemberReleaseRequiresEveryExactSiblingBinding",
            "everyImpossibleExternalizationSplitStateIsQuarantined",
            "mismatchedExternalizationStatesNeverConvergeAsApplied",
