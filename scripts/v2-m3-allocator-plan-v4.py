#!/usr/bin/env python3
"""Pure source-bound plan projection for the ADR-0125 M3 V4 allocator campaign."""
...
SCHEMA = "NEREUS_V2_M3_ALLOCATOR_CAMPAIGN_PLAN_V4"
EXECUTION_PROFILE_SCHEMA = "NEREUS_V2_M3_ALLOCATOR_NATIVE_EXECUTION_PROFILE_V4"
