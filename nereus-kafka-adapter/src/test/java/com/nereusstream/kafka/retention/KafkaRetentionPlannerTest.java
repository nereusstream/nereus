...
class KafkaRetentionPlannerTest {
  ...
  void rejectsAPlannerPolicyThatIsNotTheCurrentCheckpointConfig() {
    KafkaRetentionPlanner.Snapshot exact =
        snapshot(200, -1, LogConfigHistoryEntry.CLEANUP_DELETE_FLAG, 40, 5_000);
    KafkaRetentionPlanner.Policy wrong =
        new KafkaRetentionPlanner.Policy(
            8,
