...
class KafkaCanonicalCheckpointStateCodecV1Test {
    private final KafkaCanonicalCheckpointStateCodecV1 codec = new KafkaCanonicalCheckpointStateCodecV1();
    ...
    void composesAllSevenSectionsInCanonicalOrderWithFrozenBytes() throws Exception {
        ...
        assertThat(sections).extracting(KafkaCheckpointSection::sectionType).containsExactly(1, 2, 3, 4, 5, 6, 7);
        assertThat(sha256(sections)).isEqualTo("f6ee5254e80d21c39c64e3c4a4827eeebbad94337c60c0ad1c71416de5811862");
    }
    ...
    void roundTripsEmptyGenesisAcrossAllSevenRequiredSections() {
        KafkaCanonicalCheckpointState genesis = new KafkaCanonicalCheckpointState(
                0,
                0,
                0,
    ...
    void rejectsLogicalSegmentSetAndByteFactMismatches() {
        ...
        KafkaDerivedIndexState mismatchedBytes = new KafkaDerivedIndexState(
                5,
                30,
        ...
        assertThatThrownBy(() -> new KafkaCanonicalCheckpointState(
                        30,
                        5,
                        30,
        ...
        KafkaDerivedIndexState missingSegment =
                new KafkaDerivedIndexState(5, 30, List.of(), List.of(new SegmentLogicalByteIndex(0, 100, List.of())));
        assertThatThrownBy(() -> new KafkaCanonicalCheckpointState(
                        30,
                        5,
                        30,
    ...
    void rejectsIndexEntriesThatCrossOrExceedTheirVirtualSegment() {
        KafkaCanonicalCheckpointState exact = canonicalState();
        KafkaDerivedIndexState crossingSample = new KafkaDerivedIndexState(
                5,
                30,
                List.of(),
                List.of(
        ...
        KafkaDerivedIndexState crossingTime = new KafkaDerivedIndexState(
                5,
                30,
        ...
        KafkaDerivedIndexState excessiveTimestamp = new KafkaDerivedIndexState(
                5,
                30,
    ...
    void rejectsNonStableCheckpointAndMissingRequiredSection() {
        ...
        assertThatThrownBy(() -> codec.decodeSections(sections, 29, 5, 30)).hasMessageContaining("bounds");
    }
    ...
    private static KafkaCanonicalCheckpointState canonicalState() {
        ...
        KafkaVirtualSegmentState segments = new KafkaVirtualSegmentState(
                5,
                30,
                List.of(
                        new VirtualSegment(
        ...
        KafkaDerivedIndexState indexes = new KafkaDerivedIndexState(
                ...
                30,
                List.of(
                        new SegmentTimeIndex(0, List.of(new TimeIndexEntry(1_000, 5), new TimeIndexEntry(1_400, 10))),
        ...
        return new KafkaCanonicalCheckpointState(
                ...
                new KafkaLeaderEpochState(5, 30, List.of(new LeaderEpochRange(1, 0), new LeaderEpochRange(2, 20))),
                segments,
                indexes);
    }
