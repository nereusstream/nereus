...
class KafkaAsyncAppendAdmissionGuardTest {
    ...
    void admitsBothAsyncProfilesOnlyAfterAuthorityAndLag() {
        ...
        try {
            StreamId objectStream =
                    new StreamId("kafka-object-async-admission");
            StreamId bookKeeperStream =
                    new StreamId("kafka-bookkeeper-async-admission");
            ...
            KafkaBrokerCapabilitySpecification specification =
                    specification();
            KafkaGenerationProtocolActivationGuard activation =
                    new KafkaGenerationProtocolActivationGuard(
                            KafkaActivationTestSupport.CLUSTER,
                            generations,
                            KafkaStorageActivationVerifierTest
                                    .verifier(
                                            KafkaStorageActivationVerifierTest
                                                    .activeStore(
                                                            specification,
            ...
            MaterializationLagGate lagGate =
                    new MaterializationLagGate(
                            ...
                            new MaterializationLagThresholds(
                                    ...
                                    Duration.ofMillis(1)),
                            scheduler);
            KafkaAsyncAppendAdmissionGuard guard =
    ...
    private static AppendAdmissionRequest request(
            StreamId streamId,
