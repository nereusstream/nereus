...
public record NereusKafkaCompactionRuntimeConfiguration(
    ...
    public NereusKafkaCompactionRuntimeConfiguration {
        ...
        bounded(sourceReadPageBytes, 64 * 1024, 64 * 1024 * 1024, "sourceReadPageBytes");
        ...
        generationOperationTimeout = positive(generationOperationTimeout, "generationOperationTimeout");
