...
public final class KafkaCanonicalCheckpointPublicationFactory {
  ...
  public KafkaCheckpointPublicationRequest create(
    ...
    KafkaCheckpointSourceState exactSource =
        Objects.requireNonNull(capturedSource, "capturedSource");
    KafkaCanonicalCheckpointState exactState =
        Objects.requireNonNull(capturedState, "capturedState");
    KafkaCheckpointSourceValidator exactValidator =
    ...
    KafkaCheckpointWriteRequest objectRequest =
        new KafkaCheckpointWriteRequest(
            nereusCluster,
            header,
            stateCodec.encodeSections(exactState),
            contentPolicySha256,
            objectTimeout);
