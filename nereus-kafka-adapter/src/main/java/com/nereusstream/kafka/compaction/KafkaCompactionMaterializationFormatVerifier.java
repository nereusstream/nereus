 ...
 */
public final class KafkaCompactionMaterializationFormatVerifier implements MaterializationFormatVerifier {
    ...
    private static void requireAgreement(
        ...
        if (metadata.view() != ReadView.TOPIC_COMPACTED
            ...
            throw new CompactedObjectFormatException("NTC2 metadata does not match task/output publication facts");
        }
    }
}
