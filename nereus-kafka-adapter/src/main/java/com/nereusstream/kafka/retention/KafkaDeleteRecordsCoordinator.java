...
public final class KafkaDeleteRecordsCoordinator {
    ...
    public CompletableFuture<Result> deleteTo(KafkaTrimBarrier.Snapshot captured, long normalizedRequestedOffset) {
        ...
        return barrier.advanceDeleteRecords(captured, normalizedRequestedOffset)
                .thenApply(trim -> new Result(normalizedRequestedOffset, trim.durableTrimOffset(), Optional.of(trim)));
    }
    ...
    public record Result(long requestedOffset, long durableLowWatermark, Optional<KafkaTrimBarrier.Result> trimResult) {
        public Result {
