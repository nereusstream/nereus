...
public interface KafkaPartitionStorageManager extends AutoCloseable {
    ...
    CompletableFuture<Void> resign(KafkaPartitionIdentity identity, int observedLeaderEpoch, Duration timeout);

    CompletableFuture<Void> delete(KafkaPartitionIdentity identity, long metadataOffset, Duration timeout);
