...
public final class TransactionMarkerCompletionGateAgent {
    private static final String PROPERTY_PREFIX =
            "nereus.f9.transaction.marker.completion.gate.";
    ...
    public static void premain(
        ...
        if (!phase.equals("before-provider") && !phase.equals("after-provider")) {
            throw new IllegalArgumentException(
                    "unsupported transaction marker completion gate phase: " + phase);
        }
        ...
        new AgentBuilder.Default()
                ...
                .type(named(
                        "com.nereusstream.kafka.partition.DefaultKafkaPartitionStorage"))
                .transform(
                        (builder, type, classLoader, module, protectionDomain) ->
                                builder.visit(
                                        Advice.to(TransactionMarkerAppendAdvice.class)
                                                .on(named("append").and(takesArguments(2)))))
                .type(named("kafka.log.nereus.NereusUnifiedLog"))
                .transform(
                        (builder, type, classLoader, module, protectionDomain) ->
                                builder.visit(
                                        Advice.to(AppendFailureAdvice.class)
                ...
                .transform(
                        (builder, type, classLoader, module, protectionDomain) ->
                                builder.visit(
                                        Advice.to(AppendFailureAdvice.class)
                                                .on(named("appendRecordsToLeader")
                                                        .and(takesArguments(6)))))
                .type(named(
                        "com.nereusstream.kafka.runtime.KafkaBoundedAppendExecutor"))
                .transform(
                        (builder, type, classLoader, module, protectionDomain) ->
                                builder.visit(
                                        Advice.to(ExecutorFailureAdvice.class)
    ...
    private static Map<String, String> parseArguments(String agentArguments) {
        if (agentArguments == null || agentArguments.isBlank()) {
            throw new IllegalArgumentException(
                    "transaction marker completion gate arguments are required");
        }
        ...
        for (String token : agentArguments.split(",")) {
            ...
            if (separator <= 0 || separator == token.length() - 1) {
                throw new IllegalArgumentException(
                        "invalid transaction marker completion gate argument: " + token);
            }
            String key = token.substring(0, separator);
            String value = token.substring(separator + 1);
            if (parsed.putIfAbsent(key, value) != null) {
                throw new IllegalArgumentException(
                        "duplicate transaction marker completion gate argument: " + key);
            }
        }
    ...
    private static String require(Map<String, String> configuration, String key) {
        ...
        if (value == null || value.isBlank()) {
            throw new IllegalArgumentException(
                    "missing transaction marker completion gate argument: " + key);
        }
        return value;
    }
    ...
    public static void writeMarker(Path marker, String value) {
        try {
            ...
            throw new IllegalStateException(
                    "cannot write transaction marker completion gate marker " + marker,
                    failure);
        }
    }
    ...
    public static final class TransactionMarkerAppendAdvice {
        ...
        public static boolean gateBeforeProvider(@Advice.Argument(1) Object context) {
            if (!property("phase").equals("before-provider")
                    || !armedTargetAppend(context)
                    || !capture()) {
                return false;
            }
        ...
        public static void gateCompletion(
            ...
            if (!property("phase").equals("after-provider")
                    || !armedTargetAppend(context)
                    || !capture()) {
                return;
            }
        ...
        public static boolean targetsTopic(Object context) {
            try {
                ...
                if (!(tags instanceof Map<?, ?> exactTags)) {
                    throw new IllegalStateException(
                            "Kafka append context tags are not a map: " + tags);
                }
                return property("topic").equals(exactTags.get("topic"));
            } catch (ReflectiveOperationException failure) {
                throw new IllegalStateException(
                        "cannot inspect Kafka append context topic",
                        failure);
            }
        }
        ...
        public static boolean capture() {
            ...
            try {
                ...
                throw new IllegalStateException(
                        "cannot capture transaction marker completion gate",
                        failure);
            }
        }
        ...
        public static String property(String name) {
            ...
            if (configured == null || configured.isBlank()) {
                throw new IllegalStateException(
                        "transaction marker completion gate property is absent: " + name);
            }
            return configured;
        }
    }
    ...
    public static final class ProviderCompletion implements BiConsumer<Object, Throwable> {
        ...
        public void accept(Object ignored, Throwable failure) {
            ...
            try {
                writeMarker(
                        TransactionMarkerAppendAdvice.path("applied"),
                        "after-provider");
    ...
    public static final class AppendFailureAdvice {
        ...
        public static void captureFailure(@Advice.Thrown Throwable failure) {
            ...
            try {
                ...
                throw new IllegalStateException(
                        "cannot write transaction marker append failure evidence",
                        markerFailure);
            }
        }
    }
    ...
    public static final class ExecutorFailureAdvice {
        ...
        public static void captureFailure(
                @Advice.Return CompletableFuture<?> returned
        ) {
