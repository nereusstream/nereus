...
public final class TrimCompletionLossAgent {
    private static final String PROPERTY_PREFIX =
            "nereus.f9.trim.completion.loss.";
    ...
    public static void premain(
        ...
        try {
            ...
            if (target < 0) {
                throw new IllegalArgumentException(
                        "trim completion loss target must be non-negative");
            }
        } catch (NumberFormatException failure) {
            throw new IllegalArgumentException(
                    "trim completion loss target must be a long",
                    failure);
        }
        ...
        new AgentBuilder.Default()
                ...
                .type(named(
                        "com.nereusstream.core.DefaultStreamStorage"))
                .transform(
                        (builder,
                                type,
                                classLoader,
    ...
    private static Map<String, String> parseArguments(
        ...
        if (agentArguments == null || agentArguments.isBlank()) {
            throw new IllegalArgumentException(
                    "trim completion loss agent arguments are required");
        }
        ...
        for (String token : agentArguments.split(",")) {
            ...
            if (separator <= 0 || separator == token.length() - 1) {
                throw new IllegalArgumentException(
                        "invalid trim completion loss agent argument: "
                                + token);
            }
            ...
            if (parsed.putIfAbsent(key, value) != null) {
                throw new IllegalArgumentException(
                        "duplicate trim completion loss agent argument: "
                                + key);
            }
        }
    ...
    private static String require(
        ...
        if (value == null || value.isBlank()) {
            throw new IllegalArgumentException(
                    "missing trim completion loss agent argument: "
                            + key);
        }
        return value;
    }
    ...
    private static void writeMarker(
        ...
        try {
            ...
            throw new IllegalStateException(
                    "cannot write trim completion loss marker "
                            + marker,
                    failure);
        }
    }
    ...
    public static final class TrimCompletionAdvice {
        ...
        public static boolean capture() {
            ...
            try {
                ...
                throw new IllegalStateException(
                        "cannot capture trim completion loss",
                        failure);
            }
        }
        ...
        public static String property(String name) {
            ...
            if (configured == null || configured.isBlank()) {
                throw new IllegalStateException(
                        "trim completion loss property is absent: "
                                + name);
            }
            return configured;
        }
    ...
    public static final class ProviderCompletion
        ...
        public void accept(
            ...
            try {
                writeMarker(
                        TrimCompletionAdvice.path("applied"),
                        Long.toString(
                                TrimCompletionAdvice.target()));
