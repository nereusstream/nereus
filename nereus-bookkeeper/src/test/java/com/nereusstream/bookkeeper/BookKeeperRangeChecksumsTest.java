...
class BookKeeperRangeChecksumsTest {
    ...
    void framesExactEntrySequence() {
        ...
        assertThat(checksum.value()).isEqualTo("2a06a39e1f3c9c904e6a9489c1286d4d59d4fc127be71d56afb1a713d174ec6c");
        ...
        assertThat(BookKeeperRangeChecksums.computeBytes(41, entries.subList(0, 2)))
                .isNotEqualTo(checksum);
