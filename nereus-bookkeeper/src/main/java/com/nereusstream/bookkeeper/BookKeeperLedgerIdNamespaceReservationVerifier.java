...
public final class BookKeeperLedgerIdNamespaceReservationVerifier {
    ...
    public BookKeeperLedgerIdNamespaceReservationVerifier(
            BookKeeperLedgerIdNamespaceReservationStore store, String deploymentId) {
    ...
    public CompletableFuture<BookKeeperLedgerIdNamespaceReservation> requireActive(
            BookKeeperWalConfiguration configuration, Duration timeout) {
        ...
        return store.read(
                ...
                .thenApply(value -> {
                    BookKeeperLedgerIdNamespaceReservation reservation = value.orElseThrow(
                            () -> unavailable("BookKeeper ledger-id namespace reservation is absent"));
