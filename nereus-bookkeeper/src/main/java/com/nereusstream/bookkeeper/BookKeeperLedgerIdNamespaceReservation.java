...
public record BookKeeperLedgerIdNamespaceReservation(
    ...
    public BookKeeperLedgerIdNamespaceReservation {
        ...
        bookKeeperProviderScopeSha256 =
                BookKeeperWalConfiguration.sha256(bookKeeperProviderScopeSha256, "bookKeeperProviderScopeSha256");
        operatorEvidenceSha256 = BookKeeperWalConfiguration.sha256(operatorEvidenceSha256, "operatorEvidenceSha256");
