...
public final class BookKeeperLedgerIdNamespaceReservationKeys {
    ...
    public static String key(String providerScopeSha256, int prefixBits, long prefixValue) {
        String scope = BookKeeperWalConfiguration.sha256(providerScopeSha256, "providerScopeSha256");
    ...
    public static void requireExact(String rawKey, String providerScopeSha256, int prefixBits, long prefixValue) {
