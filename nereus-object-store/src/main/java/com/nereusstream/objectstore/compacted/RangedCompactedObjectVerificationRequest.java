...
public record RangedCompactedObjectVerificationRequest(
    ...
    public static RangedCompactedObjectVerificationRequest from(
            RangedCompactedObjectWriteRequest request, RangedCompactedObjectWriteResult result, Duration timeout) {
        return from(
                request.streamId(),
                ReadView.COMMITTED,
    ...
    public static RangedCompactedObjectVerificationRequest from(
            KafkaTopicCompactedObjectWriteRequest request, RangedCompactedObjectWriteResult result, Duration timeout) {
        return from(
                request.streamId(),
