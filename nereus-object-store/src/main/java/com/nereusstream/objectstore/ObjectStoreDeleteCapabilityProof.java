...
public record ObjectStoreDeleteCapabilityProof(
        int protocolVersion, String capabilitySha256, String probeObjectKeySha256, long completedAtMillis) {
    ...
    public ObjectStoreDeleteCapabilityProof {
        ...
        probeObjectKeySha256 = requireSha256(probeObjectKeySha256, "probeObjectKeySha256");
