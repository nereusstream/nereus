...
public record KafkaCheckpointUploadIdentity(
        ObjectId objectId, ObjectKey objectKey, long objectLength, Checksum storageCrc32c, Checksum objectSha256) {
    public KafkaCheckpointUploadIdentity {
        ...
        if (storageCrc32c.type() != ChecksumType.CRC32C || objectSha256.type() != ChecksumType.SHA256) {
