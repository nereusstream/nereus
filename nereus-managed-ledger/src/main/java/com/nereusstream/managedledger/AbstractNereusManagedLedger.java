...
abstract class AbstractNereusManagedLedger implements ManagedLedger {
    ...
    public String getName() {
        throw errorMapper.unsupportedRuntime("getName");
    }

    @Override
    public Position addEntry(byte[] data) throws ManagedLedgerException {
        throw unsupported("addEntry");
    }
    ...
    public void asyncAddEntry(byte[] data, AddEntryCallback callback, Object ctx) {
        callback.addFailed(unsupported("asyncAddEntry"), ctx);
    }
    ...
    public ManagedCursor newNonDurableCursor(Position startCursorPosition) throws ManagedLedgerException {
        throw unsupported("newNonDurableCursor");
    }
    ...
    public void asyncDeleteCursor(String name, DeleteCursorCallback callback, Object ctx) {
        callback.deleteCursorFailed(unsupported("deleteCursor"), ctx);
    }

    @Override
    public void deleteCursor(String name) throws ManagedLedgerException {
        throw unsupported("deleteCursor");
    }
    ...
    public void asyncOpenCursor(String name, OpenCursorCallback callback, Object ctx) {
        callback.openCursorFailed(unsupported("openCursor"), ctx);
    }
    ...
    public long getNumberOfEntries(Range<Position> range) {
        throw errorMapper.unsupportedRuntime("getNumberOfEntries(range)");
    }
    ...
    public CompletableFuture<Long> getEarliestMessagePublishTimeInBacklog() {
        return unsupportedFuture("getEarliestMessagePublishTimeInBacklog");
    }
    ...
    public void asyncClose(CloseCallback callback, Object ctx) {
        callback.closeFailed(unsupported("close"), ctx);
    }

    @Override
    public ManagedLedgerMXBean getStats() {
        throw errorMapper.unsupportedRuntime("getStats");
    }
    ...
    public void asyncDelete(DeleteLedgerCallback callback, Object ctx) {
        callback.deleteLedgerFailed(unsupported("delete"), ctx);
    }

    @Override
    public Position offloadPrefix(Position pos) throws ManagedLedgerException {
        throw unsupported("offloadPrefix");
    }

    @Override
    public void asyncOffloadPrefix(Position pos, OffloadCallback callback, Object ctx) {
        callback.offloadFailed(unsupported("offloadPrefix"), ctx);
    }
    ...
    public ManagedLedgerConfig getConfig() {
        throw errorMapper.unsupportedRuntime("getConfig");
    }

    @Override
    public void setConfig(ManagedLedgerConfig config) {
        throw errorMapper.unsupportedRuntime("setConfig");
    }

    @Override
    public Position getLastConfirmedEntry() {
        throw errorMapper.unsupportedRuntime("getLastConfirmedEntry");
    }
    ...
    public void skipNonRecoverableLedger(long ledgerId) {
        throw errorMapper.unsupportedRuntime("skipNonRecoverableLedger");
    }
    ...
    public CompletableFuture<Position> asyncFindPosition(Predicate<Entry> predicate) {
        return unsupportedFuture("findPosition");
    }
    ...
    public CompletableFuture<LedgerInfo> getLedgerInfo(long ledgerId) {
        return unsupportedFuture("getLedgerInfo");
    }
    ...
    public void asyncReadEntry(Position position, ReadEntryCallback callback, Object ctx) {
        callback.readEntryFailed(unsupported("readEntry"), ctx);
    }

    @Override
    public NavigableMap<Long, LedgerInfo> getLedgersInfo() {
        return java.util.Collections.unmodifiableNavigableMap(new TreeMap<>());
    }

    @Override
    public Position getNextValidPosition(Position position) {
        throw errorMapper.unsupportedRuntime("getNextValidPosition");
    }

    @Override
    public Position getPreviousPosition(Position position) {
        throw errorMapper.unsupportedRuntime("getPreviousPosition");
    }
    ...
    public Position getPositionAfterN(Position startPosition, long n, PositionBound bound) {
        throw errorMapper.unsupportedRuntime("getPositionAfterN");
    }
    ...
    public CompletableFuture<Position> getLastDispatchablePosition(Predicate<Entry> predicate, Position startPosition) {
        return unsupportedFuture("getLastDispatchablePosition");
    }

    @Override
    public Position getFirstPosition() {
        throw errorMapper.unsupportedRuntime("getFirstPosition");
    }
}
