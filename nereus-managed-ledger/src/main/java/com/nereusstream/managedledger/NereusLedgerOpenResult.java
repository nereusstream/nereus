...
public record NereusLedgerOpenResult(
        TopicProjectionRecord topicProjection, VirtualLedgerProjection projection, StreamMetadata streamMetadata) {
    public NereusLedgerOpenResult {
        ...
        if (!topicProjection
                        .projectionIdentity()
                        .equals(new com.nereusstream.metadata.oxia.records.ManagedLedgerProjectionIdentity(
