 ...
 */
public record ManagedLedgerPhysicalDeletionActivationRequest(String runId, int maxConcurrentStreams, Duration timeout) {
    ...
    public ManagedLedgerPhysicalDeletionActivationRequest {
        ...
        if (maxConcurrentStreams <= 0 || maxConcurrentStreams > MAX_CONCURRENT_STREAMS) {
