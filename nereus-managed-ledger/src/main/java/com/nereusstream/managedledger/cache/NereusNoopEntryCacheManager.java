...
public final class NereusNoopEntryCacheManager implements EntryCacheManager {
    ...
    @Override
    public void updateCacheEvictionExtendTTLOfEntriesWithRemainingExpectedReadsMaxTimes(int times) {}

    @Override
    public void updateCacheEvictionExtendTTLOfRecentlyAccessed(boolean enabled) {}
    ...
    private record NoopEntryCache(String name) implements EntryCache {
        ...
        @Override
        public void asyncReadEntry(ReadHandle handle, Position position, ReadEntryCallback callback, Object ctx) {
