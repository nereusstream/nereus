...
public interface CursorSnapshotStore extends AutoCloseable {
    ...
    CompletableFuture<Void> completeWrite(CursorSnapshotPublication publication, VersionedCursorState publishedRoot);

    CompletableFuture<CursorAckState> read(CursorSnapshotReference reference, CursorIdentity expectedIdentity);
