...
final class CursorTestSamples {
    ...
    static CursorIdentity identity() {
        ...
        return new CursorIdentity(ledger, CURSOR, CursorNames.cursorNameHash(CURSOR), 1);
    }
    ...
    static CursorAckState complexState() {
        ...
        return new CursorAckState(10, List.of(new OffsetRange(12, 14), new OffsetRange(20, 21)), partials);
    }
