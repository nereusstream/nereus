...
public record MaterializationSourceProvider(
        ReadTargetReader reader, MaterializationSourceProtectionAdapter<?> protectionAdapter) {
    public MaterializationSourceProvider {
        reader = Objects.requireNonNull(reader, "reader");
        protectionAdapter = Objects.requireNonNull(protectionAdapter, "protectionAdapter");
