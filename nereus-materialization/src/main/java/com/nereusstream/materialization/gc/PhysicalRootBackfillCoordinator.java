...
public interface PhysicalRootBackfillCoordinator {
    CompletableFuture<PhysicalRootBackfillReport> run(PhysicalRootBackfillRequest request);
    ...
    default CompletableFuture<PhysicalRootBackfillReport> runRollover(
            PhysicalRootBackfillRequest request, VersionedGenerationProtocolActivation current) {
