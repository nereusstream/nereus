...
public record GcMetadataRetirementContext(
        VersionedPhysicalObjectRoot deletingRoot, GcRetirementJournalSnapshot journal) {
    public GcMetadataRetirementContext {
        ...
        if (deletingRoot.value().lifecycle() != PhysicalObjectLifecycle.DELETING
            ...
            throw new IllegalArgumentException("metadata-retirement context root and journal do not match");
        }
    }
}
