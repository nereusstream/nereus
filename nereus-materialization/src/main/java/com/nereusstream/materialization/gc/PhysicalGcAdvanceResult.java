...
public record PhysicalGcAdvanceResult(
        PhysicalGcAdvanceStatus status, Optional<VersionedPhysicalObjectRoot> root, OptionalLong retryAtMillis) {
    ...
    public static PhysicalGcAdvanceResult waiting(PhysicalGcAdvanceStatus status, long retryAtMillis) {
        return new PhysicalGcAdvanceResult(status, Optional.empty(), OptionalLong.of(retryAtMillis));
    }

    public static PhysicalGcAdvanceResult withRoot(PhysicalGcAdvanceStatus status, VersionedPhysicalObjectRoot root) {
        return new PhysicalGcAdvanceResult(status, Optional.of(root), OptionalLong.empty());
    }
}
