...
public record RecoveryCheckpointProtections(
        ObjectProtection checkpointObject, List<ObjectProtection> checkpointTargets) {
    public RecoveryCheckpointProtections {
        Objects.requireNonNull(checkpointObject, "checkpointObject");
        checkpointTargets = List.copyOf(Objects.requireNonNull(checkpointTargets, "checkpointTargets"));
    }
}
