 ...
 */
final class MaterializationExecutionException extends NereusException implements MaterializationFailure {
    private final TaskFailureClass failureClass;

    MaterializationExecutionException(
            TaskFailureClass failureClass, ErrorCode code, boolean retriable, String message) {
