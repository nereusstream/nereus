...
public final class GenerationPublicationReconciler {
    ...
    public CompletableFuture<GenerationCommitResult> reconcile(MaterializationTask task, MaterializationOutput output) {
        try {
            return Objects.requireNonNull(
                    committer.publish(Objects.requireNonNull(task, "task"), Objects.requireNonNull(output, "output")),
