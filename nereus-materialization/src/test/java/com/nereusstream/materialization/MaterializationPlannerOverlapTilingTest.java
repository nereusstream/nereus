...
class MaterializationPlannerOverlapTilingTest {
    ...
    void selectsOneCanonicalWholeEdgePathAcrossNestedAndCrossingGenerations() {
        ...
        List<MaterializationTask> tasks = MaterializationPlannerTestSupport.planner(candidates, List.of(), 0, 6)
        ...
        assertThat(selected.sources())
                .extracting(SourceGeneration::indexKey)
