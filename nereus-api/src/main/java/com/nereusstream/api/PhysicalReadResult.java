...
public record PhysicalReadResult(
        List<ReadBatch> batches, List<PhysicalReadStats> rangeStats, OptionalLong sourceCoverageEndOffset) {
    public PhysicalReadResult {
        ...
        sourceCoverageEndOffset = Objects.requireNonNull(sourceCoverageEndOffset, "sourceCoverageEndOffset");
