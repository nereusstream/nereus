...
| Nereus Pulsar campaign tip | same branch | `11d7ab15291ca4bbc9cc29dedd7878c4e1311ec9` | `5.0.0-M1` |
...
publication/readiness management plane, admin APIs required by the Helm gate,
and the final M1 deletion-lag and Oxia-delete corrections.
`nereus/gradle.properties:pulsarExpectedHead` is pinned to the full campaign-tip
commit above. The Nereus commit cannot self-embed its own SHA;
