...
F2-M2 projection metadata、F2-M3 factory/ledger facade 和 F2-M4 cursor boundary 也已实现；当前下一实现
里程碑是 F2-M5 real broker ownership restart/failover and broker E2E；generation-safe write-fence handoff 与
shared-store peer lifecycle resume 已完成。
Legacy L0 合同以
