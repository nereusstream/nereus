...
checkpoints、Pulsar Entry/NCP1 exact-byte round trip 与 topic-compaction neutral SPI/registry 已落地；
topic-compaction execution engine/worker、terminal metadata retirement 与 M3 gates 仍 pending，
