...
| --- | --- | --- | --- |
| F1 Core Stream Storage | Phase 1 M0-M8 + Phase 1.5 P15-M0-M6 + F1-BK BK-M0-M6 | Phase 1/1.5 and F1-BK BK-M0–BK-M2 implemented/final-gated；BK-M3 focused implementation through real publication/read/physical-delete、fresh-runtime response loss、lag admission and unreadable-output fail-closed evidence；BK-M4–M6 not implemented | register and execute the BK-M3 final gate, then continue BK-M4 sync completion |
