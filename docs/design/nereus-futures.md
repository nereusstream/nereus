...
| F3 Cursor/Subscription | Phase 3 F3-M0-M6 | Designed/In progress；M0/M0R gated, M1 foundation and M2 state machines final-gated | implement F3-M3 facade |
...
已 final-gated；接下来推进 M3-M6。F4 production 在 F3 durable cursor/retention gates 完成前
...
Current milestone: F3-M0/M0R complete（design-only）；F3-M1 foundation and F3-M2 state machines
complete/final-gated，M3-M6 not started
