...
| F4 Materialization/Compaction | Phase 4 F4-M0-M6 | In progress / F4-M1–M2 final-gated；M3 format + planner/recovery checkpoints landed | Complete F4-M3 Pulsar opaque round trip、exact-source worker/service and gates |
...
scanner landed, but no exact-source compacted object worker、GC or async path exists yet
