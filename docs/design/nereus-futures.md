...
| --- | --- | --- | --- |
| F1 Core Stream Storage | Phase 1 M0-M8 + Phase 1.5 P15-M0-M6 + F1-BK BK-M0-M6 | Phase 1/1.5 implemented/final-gated；F1-BK BK-M0/BK-M1 complete/final-gated；BK-M2 through real Oxia/BookKeeper restart/delete checkpoint；BK-M3 through first real Oxia/BK/Object publication/read/retirement-proof checkpoint；BK-M4–M6 not implemented | finish BK-M3 response-loss/physical-release final gate while closing remaining BK-M2 aggregate evidence |
