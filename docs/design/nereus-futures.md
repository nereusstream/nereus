...
| F4 Materialization/Compaction | Phase 4 F4-M0-M6 | In progress / F4-M1 final-gated | Implement F4-M2 generation publication and committed read |
...
reader/protection primitives implemented/final-gated；F4-M2 is next and no generation/GC/async path exists yet
