...
| F4 Materialization/Compaction | Phase 4 F4-M0-M6 | In progress / F4-M1–M2 final-gated；M3 format checkpoint landed | Complete F4-M3 Pulsar opaque round trip、planner and worker |
...
writer/strict-reader/full verifier、NTC1 facade and core adapter landed, but no compacted object worker、GC or async
path exists yet
