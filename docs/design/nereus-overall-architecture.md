...
> 状态：North-star design；Future 1 / Phase 1 + Phase 1.5 P15-M0-M5 complete，F2-M0/M0R reviewed
> 最近实现同步：2026-07-11
...
Future 1 / Phase 1 M0-M8 和 Phase 1.5 P15-M0-M5 已完成。F2-M0/M0R 设计/API review 锁定的共享 L0
前置已经实现并通过普通与 Docker-backed final gates；F2-M1 projection foundation 是下一实现里程碑。
...
| F2 | ManagedLedger facade and virtual positions | In progress（M0/M0R design complete；F2-M1 next） |
