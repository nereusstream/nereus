...
Oxia/LocalStack final gates。M4 through checkpoint AV 已实现 NRC1 protocol、protected generation-zero append、
...
MARKED root, converge through one durable DELETING intent and safely execute idempotent exact-delete recovery. M5
