...
Oxia/LocalStack final gates。M4 through checkpoint AU 已实现 NRC1 protocol、protected generation-zero append、
...
and zero after an independent restart. M5
