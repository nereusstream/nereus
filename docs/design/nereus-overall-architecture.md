...
> 状态：North-star design；Future 1 / Phase 1 + Phase 1.5 P15-M0-M6 + F2-M1-M5 complete，F2-M6 active
> 最近实现同步：2026-07-13
...
cumulative-result handoff。F2-M1-M5 已完成；F2-M5 已实现 product-side runtime/S3 provider，以及 Pulsar
...
flowchart TB
    ...
    subgraph Adapters["Compatibility projections"]
        MLF["ManagedLedger facade (F2-M1-M5 implemented; M6 active)"]
...
| F2 | ManagedLedger facade and virtual positions | In progress（M0/M0R/M0R2 + P15-M6 + F2-M1-M5 complete；F2-M6 active） |
