...
> 状态：North-star design；Future 1 / Phase 1 + Phase 1.5、Future 2、Future 3 与 Future 4 F4-M1–M2 complete/final-gated；F4-M3 object-format checkpoint implemented，M3 remainder/M4–M6 pending
...
- Future 4 end-to-end materialization/compaction remains unavailable until the remaining F4-M3 worker/gates and
  ...
  implemented/final-gated，and only the first F4-M3 format checkpoint is executable。
...
| F4 | Materialization/compaction/generation/GC | In progress；F4-M1–M2 final-gated；F4-M3 Parquet writer/strict-reader checkpoint implemented，remaining M3/M4–M6 pending |
