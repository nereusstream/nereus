...
> 状态：North-star design；Future 1 / Phase 1 + Phase 1.5 P15-M0-M5 complete，F2-M0/M0R/M0R2 reviewed，P15-M6 next
> 最近实现同步：2026-07-11
...
Future 1 / Phase 1 M0-M8 和 Phase 1.5 P15-M0-M5 已完成。F2-M0/M0R/M0R2 设计/API review 锁定的原共享
L0 前置已经实现并通过普通与 Docker-backed final gates；M0R2 新发现的窄 P15-M6 cumulative-result
handoff 是下一实现里程碑，随后才是 F2-M1 projection foundation。
...
| F2 | ManagedLedger facade and virtual positions | In progress（M0/M0R/M0R2 design complete；P15-M6 next，then F2-M1） |
