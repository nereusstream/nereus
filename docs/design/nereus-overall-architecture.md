...
metadata/snapshot 基础生产代码与 focused tests 已进入实现，但 milestone gate/真实集成尚未完成，M2-M6
...
| F3 | Cursor/subscription durable state | Designed/In progress；M0/M0R gated，M1 foundation underway |
