...
> 状态：North-star design；Future 1 / Phase 1 + Phase 1.5、Future 2、Future 3 complete/final-gated
...
- Future 4 materialization/compaction and later tracks remain designed；Future 3 is implemented/final-gated。
