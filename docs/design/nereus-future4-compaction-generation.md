...
它们不能把 Pulsar ownership/watch 当作 cursor CAS fence。F3-M1 foundation 与 F3-M2
CursorStorage/retention protocol 已 final-gated、M3-M6 尚未开始；在 F3 gates 完成前，F4 不得先行启用 generation publish 或
physical GC。
