...
> restart/BookKeeper gate passed；F4-M1–M5 are final-gated；F4-M6 checkpoints BD–BL cover 32-ref merge、
...
> provider-neutral Hadoop/Oxia logging composition and
...
Pulsar retention rollout but does not claim M6 scale/failure/compatibility certification. M6 checkpoints BD–BL are
...
Hadoop reload4j backend that broke Oxia retry recovery in the combined runtime. The complete aggregate
