...
- **F1-BK / BookKeeper Primary WAL Delivery**：Future 1 的后续扩展，不是 Future 5；BK-M0–M6 的代码级
  ...
  real Oxia/BK/Object publication/read/proof checkpoints are implemented，response-loss/physical-release final gate and
