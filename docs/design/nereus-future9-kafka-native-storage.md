...
> 2026-07-29 增量：two-release-process Object-WAL singleton handoff、three-release-process Object-WAL already-in-flight fencing，以及真实 ZooKeeper/two-bookie/two-release-process BookKeeper WAL-only/async/sync post-handoff matrix 均通过；BookKeeper already-in-flight cut、coordinator migration、multi-controller 与更广 chaos 仍 open
