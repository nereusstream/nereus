...
| `nereus-future4-compaction-generation.md` | Future 4 compaction and generation replacement design | current future design |
| `nereus-storage-object-format.md` | Nereus object/index/table format for Future 1/4/6/8 | current design draft |
| `nereus-commit-protocol.md` | Nereus append/compaction/cursor/txn commit protocol for Future 1/3/4/6/8 | current design draft |
| `nereus-future5-kop-compatibility.md` | Future 5 KoP/Kafka projection on Nereus storage | current design draft |
| `nereus-future6-lakehouse-sbt-sdt.md` | Future 6 lakehouse SBT/SDT design | current future design |
| `nereus-future7-routing-brownout-elasticity.md` | Future 7 routing, brown-out, and elasticity design | current design draft |
| `nereus-future8-advanced-pulsar-semantics.md` | Future 8 advanced Pulsar semantics design | current future design |
...
1. Read `nereus-overall-architecture.md` for the full product architecture.
