...
> final gates 已于 2026-07-15 通过；F4-M4 through checkpoint AX 已实现 opt-in physical-GC composition，并以
...
> 1,001-root hot-shard + all-shard 1,256-root real-Oxia bounded pagination；
