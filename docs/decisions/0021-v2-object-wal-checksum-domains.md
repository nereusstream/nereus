...
Storage Epoch format/checksum/encryption families fix which algorithm/version pairs are legal within that epoch. An
algorithm change requires a new format/epoch contract as applicable; mutable policy cannot silently reinterpret an
...
This decision refines ADR 0018 and is tracked by `T-OBJECT-01`, `V2-OBJ-001`, and `V2-OBJ-003`.
