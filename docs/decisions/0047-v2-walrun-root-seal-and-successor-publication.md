...
immutable `WalRunSealRecord` that binds the Root key/SHA, terminal extent sequence, and exact typed terminal coverage.
A successor Root references both the predecessor Root key/SHA and its Seal key/SHA.
