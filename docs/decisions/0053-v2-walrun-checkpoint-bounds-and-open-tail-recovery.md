...
validates the one predecessor/vector chain and then always performs bounded strong LIST
...
override them or assert that every binding member ACKed.
...
This decision is refined by ADRs 0060/0063/0064, refines ADRs 0030, 0039, 0047, and 0049 and is tracked by
`T-OBJECT-01`, `T-HANDOFF-01`, `T-POLICY-01`, `V2-OBJ-014..021`, and `V2-OPEN-OBJ-19`.
