...
Oxia container restarted between two JVMs. The runner archives six suites/47 cases and phases, captures its checked
...
is used only for READ_FENCED veto values.
