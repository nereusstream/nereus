...
| M4 | allocation-free Binding-scoped logical `BindingReadViewSnapshot`; deterministic typed protocol/profile source plan and one-shot pre-observability fallback; bounded generation-tagged hazard slots with stable conservative scanning and ABA-safe terminal drain; fused selector/terminal/proof-window/fold/capability control; exact per-source interval verification and protection-generation release CAS; four-child evidence hierarchy; no physical deletion | **CLOSED. Exact tested source `fe0ca24bbb01f2db5320bd8e001b3e0820fd95dc` binds four children, the evidence-selected physical/capability choices, five M4-only scenario promotions, and canonical immutable Final SHA-256 `83b3f64edf7d3e4402ed11e6b2d4bb6aaf014e2aec9002448bf1318e14317603`. M5 physical deletion, M6 process activation, M8 native parity, and production deployment authority remain excluded.** | `v2M4Check` |
...
`v2M4Check` is authoritative after its four exact-source children and canonical Final are published and synchronized.

## Closed milestone: M4

| Item | Frozen value |
| --- | --- |
| Exact tested source | `fe0ca24bbb01f2db5320bd8e001b3e0820fd95dc` |
| Tested source-lock SHA-256 | `02601b3de76857d5f0c8657b285bc91584486d08077e201a4d9fd34f377b07a2` |
| Canonical Final | `docs/v2/evidence/v2-m4/final/canonical/m4-final.json` |
| Final SHA-256 | `83b3f64edf7d3e4402ed11e6b2d4bb6aaf014e2aec9002448bf1318e14317603` |
