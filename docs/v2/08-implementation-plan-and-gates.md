...
implementation checkpoints recorded by the M3 index. They are still not formal Provider/KMS/allocator receipts,
current-source M2 regression, scenario promotion, or Final. No empty task, documentation-only receipt, synthetic Root
fixture, diagnostic real-service run, or focused local PASS may promote an M3 scenario.
