...
focused current-source evidence; the active-graph edge cut is complete, while mechanical V1/KoP deletion and trusted
N2/N3 execution remain pending, and neither M1-2 nor the G1 focused wrapper can stand in for Final.
