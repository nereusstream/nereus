...
still required at that historical boundary.

[ADR 0140](../../../decisions/0140-v2-m3-allocator-v5-selection-child-final-source-binding-amendment.md) and the
[V5 selection, child, and Final source-binding record](stage-b-v5-selection-child-final-source-binding.md) bind the
subsequent exact `d5b3569b...` PASS diagnostic and completed selected formal. Canonical NAEV5 and NARS5 select
RANGE-64, the immutable 160-file archive independently rehashes, and the production lock is now `RANGE`. The
governed V5 wrapper replays the nested planner, physical aggregates, diagnostic inventories, promotion decision, and
