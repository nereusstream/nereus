...
261/0/0/0 respectively at this implementation boundary. The exact `35e6784d...` R execution now passes 9/0/0/0 and
publishes non-promotable [control/recovery child](../../evidence/v2-m3/children/05-R_CONTROL_RECOVERY/receipt.json)
`1863f293...8f90`; K still lacks an exact-source child. The protocol fixture does not freeze complete synthetic
Root/Pointer wire.
