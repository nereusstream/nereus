...
| --- | --- | --- |
| M3-I0 | [NWG1 implementation-input closure](m3-i0-nwg1-implementation-input-closure.md) | accepted documentation-only input; no codec, runner, trace harness, Provider evidence, receipt, or scenario PASS |
...
| M3-W2 | NWG1 production encoder/decoder, projection, six-vector A corpus, and exact wire gate | planned; exact bytes and `PASS_LOCAL_NWG1_WIRE_ONLY` do not exist |
