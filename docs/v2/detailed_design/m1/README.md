...
| `P1` | selector CAS, authoritative ownership A/read/B, atomic ACTIVE fence and invalidation | immutable N1 artifact plus `M1.1a-O2` | Pulsar/Oxia focused source gate | [accepted code-level design](p1-pulsar-selector-and-ownership-fence.md); Nereus real-Oxia lifecycle and Pulsar native primitives implemented, exact artifact/admission/combined receipt pending |
