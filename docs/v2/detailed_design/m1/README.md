...
| `N1` | immutable, non-overwriteable domain/SPI artifact with source/JAR/source-JAR/POM/metadata identities | accepted M1-2 receipt caps | immutable artifact publication gate | [accepted implementation design](n1-immutable-domain-artifact.md); publication in progress |
