...
| M2-K9 | [Real BookKeeper fault and scale evidence](kafka-m2-k9-real-bookkeeper-evidence.md) | exact-image provider/engine calibration complete; thresholds, harness, and complete operational-default implementation fixed; current-source formal receipt pending |
