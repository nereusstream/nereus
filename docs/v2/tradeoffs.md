...
| T-MULTIPROTOCOL-01 | Accepted | independent Kafka/Pulsar Protocol Cells may share one Storage Fabric | provider utilization and one lifecycle platform without merging protocol authority | shared infrastructure can enlarge noisy-neighbor and failure blast radius | `V2-MULTIPROTOCOL-001`; close `V2-OPEN-FABRIC-01` before production cell sharing |
