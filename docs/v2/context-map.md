...
- [Shared Storage](domain/shared-storage/CONTEXT.md) — owns storage-profile epochs, typed protocol coverage,
  physical extents, manifests, materialization, and safe physical lifecycle.
- [Kafka](domain/kafka/CONTEXT.md) — owns Kafka topic-partition identity, offsets, protocol state, and Kafka-native
  write authority.
- [Pulsar](domain/pulsar/CONTEXT.md) — owns Pulsar topic/ManagedLedger identity, positions, MessageIds, cursors,
