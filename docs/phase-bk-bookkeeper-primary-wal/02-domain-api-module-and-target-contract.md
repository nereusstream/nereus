...
6. runtime registration remains opt-in；BK-M2/M3/M4 activate the exact module-local profile capabilities。BK-M5 later
   final-gates production registration behind exact activation/capability admission；this does not weaken M1's seam。
