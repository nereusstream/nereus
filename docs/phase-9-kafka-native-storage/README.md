...
`f9MultiBrokerTakeoverProcessIntegrationTest` 现在进一步使用 fork `bb7e8937c5` 的真实 release tarball 启动两个
...
reassignment 瞬间已经 dispatch 的旧 append，也没有覆盖 BookKeeper profile、transaction/internal-topic
