...
及其首个真实 process profile 已实现；其余 async/sync creator、checkpoint time-index candidate、完整五档
...
namespace/activation/readiness authority 仍在 Oxia，Kafka 运行时不依赖 Pulsar metadata driver。async/sync materialization、
