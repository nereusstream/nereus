...
> Kafka fork development head：`nereusstream/kafka:nereus/future9-native-kafka-storage@bf8a2946e5daf521b817708b2ed4324a974c2cf6`（51 commits / 124 files from Apache `427b409cf440f745ad6195673d3342f6bd3974d4`；第 49 个 `bd9963c980` 增加 stock retention oracle，第 50 个 `c4a0a2d1fa` 增加 stock `LogCleaner` compaction oracle，第 51 个 `bf8a2946e5` 让隔离 Nereus development coordinates 以 changing/zero-cache 解析）；working clone `/Users/liusinan/apps/ideaproject/nereusstream/kafka`；SSH push is configured and the remote head is verified
