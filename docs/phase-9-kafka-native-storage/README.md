...
partition 枚举的 product bridge 已实现；提供 production fork partition registration 与真实
partition-lock/KRaft authority capture、运行 provider fresh-process restart gates，以及 stock cleaner oracle 仍待实现。
