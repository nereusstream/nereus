...
WAL-only 无物化注册、async 缺失注册、L0 profile 漂移和 composite lifecycle。真实 BookKeeper ledger
物理删除、fresh-process restart/read fallback 仍待 provider/process gate，因此当前仍不能宣称物理删除验收完成。
