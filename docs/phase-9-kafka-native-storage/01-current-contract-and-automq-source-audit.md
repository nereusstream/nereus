...
| `nereus-api/.../StreamStorage.java` | `eb0d309b33676c4786b5134ded3840ce761386bd` | binary-safe append/read/authority/head-snapshot/commit-reachability overloads；legacy-equivalent delegates，new unsupported semantics fail closed |
...
| `nereus-core/.../DefaultStreamStorage.java` | `2b6aa2510c3a110839988fd0b849200f00b67523` | production overrides conditional append、semantic read、authority-bound session、exact stable-head and commit-reachability overloads |
