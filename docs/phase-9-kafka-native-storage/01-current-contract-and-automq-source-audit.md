...
| `nereus-api/.../StreamStorage.java` | `cb2af2053cf43d877fc57ff136d36f569791431b` | binary-safe append/read/authority/head-snapshot overloads；legacy-equivalent delegates，new unsupported semantics fail closed |
| `nereus-api/.../StableStreamHeadSnapshot.java` | `b77879fcbd8612a8d1e6bdbeb18382eb1df4d9e7` | exact commit/trim/session/authority/canonical durable-head digest；genesis commit version 0 is explicit |
...
| `nereus-core/.../DefaultStreamStorage.java` | `c4bf3a4a2e05c9bba15a365c1dd1bf0d24623276` | production overrides conditional append、semantic read、authority-bound session and exact stable-head snapshot overloads |
