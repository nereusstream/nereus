...
| `nereus-api/.../StreamStorage.java` | `c49f798a3cd54471c63480a8945fef40b3a58ed0` | binary-safe append/read/authority overloads；legacy-equivalent delegates，new unsupported semantics fail closed |
...
| `nereus-core/.../DefaultStreamStorage.java` | `697be84f6ddf19926920cc969244f5f0ac0aa21e` | production overrides conditional append、semantic read and authority-bound session overloads |
