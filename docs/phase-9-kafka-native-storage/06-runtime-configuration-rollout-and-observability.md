...
33 BookKeeper binding/resource/readiness keys in fork `50b46aab2d`。Primitive types、defaults、independent hard ranges、
...
client。Fork `50b46aab2d` now maps the complete typed snapshot to
