...
exact-SEALED shared-scanner trigger and first real Oxia/BK/Object publication/read/retirement-proof checkpoint；但
response-loss、physical release and final gate 尚未完成，production broker 仍在 IO
