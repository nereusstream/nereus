...
> 状态：Implemented / F4-M1–M5 final-gated；F4-M6 BD–BM evidence-green、52/52 traceability complete，aggregate compatibility pending；
...
F4-M6 BD–BM cover the current merge/candidate/checkpoint/reference/task limits、the exact 16,448-stream all-shard
...
exclusive scheduling for Docker-owning release tasks under the otherwise parallel aggregate.
