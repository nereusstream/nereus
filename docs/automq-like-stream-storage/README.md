...
> 状态：Implemented / F4-M1–M5 final-gated；F4-M6 BD–BL evidence-green、52/52 traceability complete，aggregate compatibility pending；
...
F4-M6 BD–BL cover the current merge/candidate/checkpoint/reference/task limits、the exact 16,448-stream all-shard
registry restart、real two-broker/two-worker contention with compression-heavy exact Pulsar/BookKeeper reads、
protected-intent retirement、partitioned admin compatibility and provider-neutral Hadoop/Oxia logging composition.
