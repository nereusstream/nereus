...
> dual-mode ManagedCursor facade checkpoint implemented，focused lifecycle/classification gate in progress；F3-M4+ pending
>
> Gate 日期：2026-07-14
...
| Pulsar source/API baseline | local `master@7efae25af39a15407c1397d9e1f4ac4658d09daa` |
