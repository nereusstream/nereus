...
| Current compatibility source lock | local `master@52825536806a02eeb2418c9f4a39b0802d33d849`；preserves the F3 contract and adds the F1-BK borrowed-client、runtime configuration and activation-bound profile-specific first-create capability boundaries above the BQ lock；the TTL policy-triggered expiry evidence itself remains pinned to BQ |
