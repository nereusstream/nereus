...
| Current compatibility source lock | local `master@dfbcc8e11422c965957e3e1fcf809485e437d842`；preserves the F3 contract and adds the F1-BK production ownership filter、capability rollover and mixed-profile rollout above the BQ lock；the TTL policy-triggered expiry evidence itself remains pinned to BQ |
