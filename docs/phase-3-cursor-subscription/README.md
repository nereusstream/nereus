...
| Current compatibility source lock | local `master@acce4183f2fa00511ae2951f3ee5b1937c8426cc`；preserves the F3 contract and adds the F1-BK borrowed-client、runtime configuration and profile-specific first-create capability boundaries above the BQ lock；the TTL policy-triggered expiry evidence itself remains pinned to BQ |
