...
closures are tracked in document 07；as of checkpoints AL/AI the generation/reader/task/publication/retention-rollout、
cursor-snapshot execution and current-writer inventory rows have implementation slices, while periodic lifecycle
scheduling、registration retirement and physical-GC activation/final composition remain open.
