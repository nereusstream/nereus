...
are implemented. The exact-source reader/lossless-row/claim-to-output-ready worker checkpoint is also implemented；
protection crash-cut reconciliation、service composition and M4–M6 surfaces remain target code until their milestone
