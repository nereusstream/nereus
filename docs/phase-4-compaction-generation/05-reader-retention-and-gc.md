...
object codec and canonical metadata verifier, but no recovery root references those bytes yet. M4 GC coordinators、
cursor integration and anchor-aware reachability remain planned；
