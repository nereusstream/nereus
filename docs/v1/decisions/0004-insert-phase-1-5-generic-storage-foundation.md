...
This delivery-sequencing decision belongs to the V1 Phase/Future implementation line preserved on the `v0.1`
branch. It does not define the V2 module graph, milestone sequence, API, or durable contracts.
...
profile or recovery identity。P15-M6 passed its ordinary and Docker-backed final gates on 2026-07-12；F2-M1 has
since consumed that handoff and completed its projection foundation gate。
