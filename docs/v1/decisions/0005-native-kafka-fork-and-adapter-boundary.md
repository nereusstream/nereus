...
Historical / accepted for the V1 F9 design contract on 2026-07-23; not current V2 authority. The V1 implementation and
exact source tuple are preserved on the protected V1 branches.

The V2 successors are:

- [ADR 0009](../../decisions/0009-v2-protocol-native-data-paths.md) for protocol-native Kafka and Pulsar execution
  paths;
- [ADR 0081](../../decisions/0081-v2-m1-pure-active-graph-and-promotion-boundary.md) for the V2 module graph,
  cross-repository
  promotion, and source-lock boundary;
- [ADR 0082](../../decisions/0082-v2-m1-domain-and-control-authority-contracts.md) for Kafka/KRaft control authority
  and V2 domain contracts;
- [V2 source locks](../../v2/source-locks.json) for exact development and evidence identities.

The F5/F9 naming, initial RF1 activation restrictions, implementation-status claims, and V1 stream-head authority in
the body below are historical evidence only. They must not be imported into a V2 contract without a new accepted ADR.
