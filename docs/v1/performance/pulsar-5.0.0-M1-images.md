...
| Nereus Pulsar | `5.0.0-M1-nereus` | `11d7ab15291ca4bbc9cc29dedd7878c4e1311ec9` |
| Nereus artifacts/admin | `v0.1.0` | final annotated tag or exact committed review tip |
...
`v0.1.0` commit or detached tag checkout. The script verifies the selected
full SHA and source lock; it does not depend on a branch name:
