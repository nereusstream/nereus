...
public final class BookKeeperMetadataTestValues {
    ...
    public static BookKeeperAllocationSlotRecord slot() {
        return new BookKeeperAllocationSlotRecord(
                1, 4, ALLOCATION, STREAM, 101, B, A, AllocationSlotLifecycle.CREATE_STARTED, 100, 110, 0);
    }
    ...
    public static BookKeeperAppendReservationRecord reservation() {
        return new BookKeeperAppendReservationRecord(
                ...
                1_000,
                1_100,
                AppendReservationLifecycle.DURABLE,
                "",
                "",
                0,
                "",
    ...
    public static BookKeeperLedgerReaderLeaseRecord readerLease() {
        return new BookKeeperLedgerReaderLeaseRecord(1, B, 101, 2, 3, "process-1", 4, 120, 220, 0);
    }
}
