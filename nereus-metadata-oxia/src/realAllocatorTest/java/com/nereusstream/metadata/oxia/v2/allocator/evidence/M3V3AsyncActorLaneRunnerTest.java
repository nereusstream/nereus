...
class M3V3AsyncActorLaneRunnerTest {
    ...
    @Test
    void v4AdmitsOnlyAlreadyOfferedWorkDuringTheTerminalDrain() throws Exception {
        M3V3AsyncActorLaneRunner<String> runner =
    ...
    @Test
    void v4DropsAnOnTimeRequestStillBlockedAtTheFinalAdmissionDeadline() throws Exception {
        M3V3AsyncActorLaneRunner<String> runner =
                new M3V3AsyncActorLaneRunner<>(
                        NO_WARMUP,
