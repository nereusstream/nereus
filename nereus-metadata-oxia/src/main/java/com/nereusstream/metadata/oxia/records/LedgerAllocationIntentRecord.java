...
public record LedgerAllocationIntentRecord(
    ...
    public LedgerAllocationIntentRecord {
        ...
        bookKeeperMetadataSha256 =
                BookKeeperRecordValidation.optionalSha256(bookKeeperMetadataSha256, "bookKeeperMetadataSha256");
        ...
        if ((lifecycle == LedgerAllocationLifecycle.PHYSICAL_CREATED
                        || lifecycle == LedgerAllocationLifecycle.ACTIVATED)
