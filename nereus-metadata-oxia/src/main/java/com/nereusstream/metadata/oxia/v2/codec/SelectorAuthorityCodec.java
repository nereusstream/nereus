...
/** Narrow internal selector codec port; production transition wire remains outside O2. */
public interface SelectorAuthorityCodec extends AuthorityValueCodec {
    CanonicalBytes encode(PulsarTopicGenerationSelectorValueV1 candidate);

    VersionedSelectorSnapshot decode(
