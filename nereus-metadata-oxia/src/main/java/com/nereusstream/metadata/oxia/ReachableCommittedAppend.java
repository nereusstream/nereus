...
public final class ReachableCommittedAppend {
    ...
    private ReachableCommittedAppend(
        ...
        if (headEnd < append.range().endOffset()
                || headSize < append.cumulativeSize()
                || headVersion < append.commitVersion()) {
            throw new IllegalArgumentException("invalid reachability proof");
        }
    }
    ...
    public CommittedAppend committedAppend() {
        return committedAppend;
    }

    public String observedHeadCommitId() {
        return observedHeadCommitId;
    }

    public long observedHeadOffsetEnd() {
        return observedHeadOffsetEnd;
    }

    public long observedHeadCumulativeSize() {
        return observedHeadCumulativeSize;
    }

    public long observedHeadCommitVersion() {
        return observedHeadCommitVersion;
    }
}
