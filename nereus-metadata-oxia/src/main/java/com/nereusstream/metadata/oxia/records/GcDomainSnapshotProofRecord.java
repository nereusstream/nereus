...
public record GcDomainSnapshotProofRecord(
        String domainId, int protocolVersion, String queryIdentitySha256, String snapshotSha256) {
    public GcDomainSnapshotProofRecord {
        ...
        snapshotSha256 = F4RecordValidation.requireSha256(snapshotSha256, "snapshotSha256");
    }
}
