...
public record KafkaCompactionCoverageRecord(
    ...
    @Override
    public byte[] generationSetSha256() {
        return generationSetSha256.clone();
    }
    ...
    public boolean equals(Object other) {
        return this == other
                || other instanceof KafkaCompactionCoverageRecord that
                        && coverageVersion == that.coverageVersion
    ...
    public int hashCode() {
        int result =
                java.util.Objects.hash(coverageVersion, startOffset, endOffset, activationEpoch, activatedAtMillis);
