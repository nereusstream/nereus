...
public record KafkaStorageReadinessRecord(
    ...
    public KafkaStorageReadinessRecord {
        ...
        brokerSetSha256 = KafkaMetadataValidation.sha256(brokerSetSha256, "brokerSetSha256", false);
        ...
        capabilitySha256 = KafkaMetadataValidation.sha256(capabilitySha256, "capabilitySha256", false);
        providerScopeSha256 = KafkaMetadataValidation.sha256(providerScopeSha256, "providerScopeSha256", false);
        if (readinessEpoch <= 0
                || kraftMetadataOffset < 0
                || createdAtMillis <= 0
    ...
    @Override
    public byte[] brokerSetSha256() {
        return brokerSetSha256.clone();
    }
    ...
    public boolean equals(Object other) {
        return this == other
                || other instanceof KafkaStorageReadinessRecord that
                        && recordVersion == that.recordVersion
                        && readinessEpoch == that.readinessEpoch
                        ...
                        && brokers.equals(that.brokers)
                        && Arrays.equals(brokerSetSha256, that.brokerSetSha256)
