...
/** Immutable local continuity word; the invalidation epoch is never persisted. */
public record StoreContinuitySnapshot(StoreContinuityState state, long clientGeneration, long invalidationEpoch) {
    public StoreContinuitySnapshot {
