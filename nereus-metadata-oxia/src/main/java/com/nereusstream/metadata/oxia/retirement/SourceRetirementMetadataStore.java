...
public interface SourceRetirementMetadataStore extends AutoCloseable {
     ...
     */
    CompletableFuture<Optional<VersionedGenerationZeroMarker>> getCommittedMarkerByKey(String cluster, String exactKey);
     ...
     */
    CompletableFuture<Optional<VersionedGenerationZeroCommit>> getCommitNodeByKey(String cluster, String exactKey);
