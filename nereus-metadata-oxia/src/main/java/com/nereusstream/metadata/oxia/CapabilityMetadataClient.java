...
public interface CapabilityMetadataClient {
    CompletableFuture<Optional<CapabilityMetadataValue>> get(String key, String partitionKey);

    CompletableFuture<CapabilityMetadataValue> putIfAbsent(String key, byte[] value, String partitionKey);
