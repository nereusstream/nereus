...
public record VersionedRangeRetentionStats(
        String key, RangeRetentionStatsRecord value, long metadataVersion, Checksum durableValueSha256) {
    public VersionedRangeRetentionStats {
        ...
        if (value.metadataVersion() != metadataVersion) {
            throw new IllegalArgumentException("retention stats value/version does not match wrapper");
        }
