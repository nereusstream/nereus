...
public record AppendReplayCursor(
    ...
    public AppendReplayCursor {
        Objects.requireNonNull(streamId);
        Objects.requireNonNull(commitId);
        Objects.requireNonNull(observedHeadCommitId);
        Objects.requireNonNull(nextCommitId);
        if (expectedStartOffset < 0
                || observedHeadOffsetEnd < 0
                || observedHeadCumulativeSize < 0
