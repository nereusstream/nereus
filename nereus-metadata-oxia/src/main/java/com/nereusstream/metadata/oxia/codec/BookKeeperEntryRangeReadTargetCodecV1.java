 ...
 */
public final class BookKeeperEntryRangeReadTargetCodecV1 implements ReadTargetCodec<BookKeeperEntryRangeReadTarget> {
    @Override
    ...
    public BookKeeperEntryRangeReadTarget decode(byte[] payload) {
        try {
            ...
            Checksum checksum = new Checksum(
                    ChecksumType.valueOf(reader.string("rangeChecksumType")), reader.string("rangeChecksumValue"));
            reader.finish();
