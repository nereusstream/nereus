...
public record VersionedPhysicalObjectRoot(
        String key, PhysicalObjectRootRecord value, long metadataVersion, Checksum durableValueSha256) {
    public VersionedPhysicalObjectRoot {
        ...
        if (value.metadataVersion() != metadataVersion) {
            throw new IllegalArgumentException("physical root value/version does not match wrapper");
        }
