...
/** Narrow internal Registry codec port; writer inventory/capacity remains outside O2. */
public interface RegistryAuthorityCodec extends AuthorityValueCodec {
    CanonicalBytes encode(PulsarVirtualLedgerNamespaceRegistryValueV1 candidate);

    VersionedRegistrySnapshot decode(
