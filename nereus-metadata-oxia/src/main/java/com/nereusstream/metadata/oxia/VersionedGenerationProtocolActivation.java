...
public record VersionedGenerationProtocolActivation(
        String key, GenerationProtocolActivationRecord value, long metadataVersion, Checksum durableValueSha256) {
    public VersionedGenerationProtocolActivation {
        ...
        if (value.metadataVersion() != metadataVersion) {
            throw new IllegalArgumentException("activation value/version does not match wrapper");
        }
