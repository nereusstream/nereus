...
public interface BookKeeperWriterMetadataStore extends AutoCloseable {
    CompletableFuture<Optional<BookKeeperVersionedValue<BookKeeperWriterStateRecord>>> getWriter(
            String cluster, StreamId stream);

    CompletableFuture<BookKeeperVersionedValue<BookKeeperWriterStateRecord>> createWriter(
    ...
    CompletableFuture<Void> deleteAllocation(
    ...
    CompletableFuture<Void> deleteReservation(
