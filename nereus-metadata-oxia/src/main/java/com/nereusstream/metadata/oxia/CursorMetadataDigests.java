...
public final class CursorMetadataDigests {
    ...
    public static Checksum durableValueSha256(CursorRetentionRecord record) {
        return sha256(
                F3MetadataCodecs.encodeEnvelope(Objects.requireNonNull(record, "record"), CursorRetentionRecord.class));
    }

    public static Checksum durableValueSha256(CursorStateRecord record) {
        return sha256(
                F3MetadataCodecs.encodeEnvelope(Objects.requireNonNull(record, "record"), CursorStateRecord.class));
    }
