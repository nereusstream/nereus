...
public record AppendRecoveryAnchor(
        StreamId streamId, String lastCommitId, long offsetEnd, long cumulativeSize, long commitVersion) {
    public AppendRecoveryAnchor {
        ...
        if (genesis != (offsetEnd == 0) || genesis != (cumulativeSize == 0) || genesis != (commitVersion == 0)) {
