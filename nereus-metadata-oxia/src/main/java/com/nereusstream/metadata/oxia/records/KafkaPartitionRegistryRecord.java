...
public record KafkaPartitionRegistryRecord(
    ...
    public KafkaPartitionRegistryRecord {
        ...
        bindingRootSha256 = KafkaMetadataValidation.sha256(bindingRootSha256, "bindingRootSha256", false);
    ...
    @Override
    public byte[] bindingRootSha256() {
        return bindingRootSha256.clone();
    }

    @Override
    public boolean equals(Object other) {
        return this == other
                || other instanceof KafkaPartitionRegistryRecord that
                        && formatVersion == that.formatVersion
                        && partitionId == that.partitionId
                        && lifecycleId == that.lifecycleId
                        && bindingEpoch == that.bindingEpoch
