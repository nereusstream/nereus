...
public record BookKeeperWriterStateRecord(
    ...
    public BookKeeperWriterStateRecord {
        ...
        configurationBindingSha256 =
                BookKeeperRecordValidation.sha256(configurationBindingSha256, "configurationBindingSha256");
        if (lifecycle == null) {
        ...
        if (updatedAtMillis < openedAtMillis) {
            throw new IllegalArgumentException("updatedAtMillis cannot precede openedAtMillis");
        }
        ...
        boolean active =
                lifecycle == BookKeeperWriterLifecycle.ACTIVE || lifecycle == BookKeeperWriterLifecycle.RECOVERING;
        ...
        if (!active
                && (!activeReservationId.isEmpty()
                        || nextEntryId != 0
                        || activePhysicalBytes != 0
                        || activeAppendRangeCount != 0)) {
