...
class F3MetadataGoldenTest {
    ...
    void canonicalF3EnvelopesMatchFrozenGoldenBytes() throws IOException {
        ...
        actual.put(
                "cursor.minimal",
                F3MetadataCodecs.envelopeHex(F3MetadataCodecSamples.minimalActive(), CursorStateRecord.class));
        actual.put(
                "cursor.full",
                F3MetadataCodecs.envelopeHex(F3MetadataCodecSamples.fullActive(), CursorStateRecord.class));
        actual.put(
                "cursor.deleted",
                F3MetadataCodecs.envelopeHex(F3MetadataCodecSamples.deleted(), CursorStateRecord.class));
        actual.put(
                "retention.active",
                F3MetadataCodecs.envelopeHex(F3MetadataCodecSamples.activeRetention(), CursorRetentionRecord.class));
        actual.put(
                "retention.create",
                F3MetadataCodecs.envelopeHex(
        ...
        actual.put(
                "retention.trim",
                F3MetadataCodecs.envelopeHex(F3MetadataCodecSamples.trimRetention(), CursorRetentionRecord.class));
        ...
        assertThat(actual).allSatisfy((key, value) -> assertThat(value).as(key).isEqualTo(expected.getProperty(key)));
