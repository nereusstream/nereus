...
class CursorKeyspaceTest {
    ...
    void constructsExactHashedCursorAndRetentionPathsOnTheStreamPartition() {
        ...
        StreamId streamId = ManagedLedgerProjectionNames.streamId("persistent://tenant/ns/topic", 1);
        ...
        assertThat(keyspace.cursorStateScanToExclusive(streamId)).isEqualTo(prefix + "by-hash/~/");
    ...
    void cursorNamesUseStrictUtf8AndTheLockedHashDomain() {
        ...
        assertThatThrownBy(() -> CursorNames.requireCursorName("\0")).isInstanceOf(IllegalArgumentException.class);
