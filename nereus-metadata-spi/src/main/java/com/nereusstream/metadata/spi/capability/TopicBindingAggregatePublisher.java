...
/** Publishes one immutable Topic Binding Aggregate if its authority key is absent. */
public interface TopicBindingAggregatePublisher {
    CompletionStage<CreateMutationResult<VersionedAggregateSnapshot>> publishIfAbsent(
