...
/**
 * Typed selector identity/state plus exact caller-supplied stored bytes.
 *
 * <p>This is not a backend codec and does not assign any OPEN persisted-size cap.
 */
public record PulsarTopicGenerationSelectorValueV1(
    ...
    public PulsarTopicGenerationSelectorValueV1 {
